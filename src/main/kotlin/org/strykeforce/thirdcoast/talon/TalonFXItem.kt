...
internal const val STATOR_CURRENT_LIMIT = "STATOR_CURRENT_LIMIT"
internal const val SUPPLY_CURRENT_LIMIT = "SUPPLY_CURRENT_LIMIT"
...
internal const val MOTION_PROFILE_BUFFER_COUNT = "MOTION_PROFILE_BUFFER_COUNT"
...
class TalonFXItem @JvmOverloads constructor(
    ...
    override val measures = setOf(
            ...
            Measure(STATOR_CURRENT_LIMIT, "Stator Current Limit"),
            Measure(SUPPLY_CURRENT_LIMIT, "Supply Current Limit"),
    ...
    private val supplyConfig = SupplyCurrentLimitConfiguration()
    private val statorConfig = StatorCurrentLimitConfiguration()
    val error = talonFX.configGetSupplyCurrentLimit(supplyConfig)
    val error2 = talonFX.configGetStatorCurrentLimit(statorConfig)
    ...
    override fun measurementFor(measure: Measure): DoubleSupplier {
        return when(measure.name){
            ...
            STATOR_CURRENT_LIMIT -> DoubleSupplier { statorConfig.currentLimit }
            SUPPLY_CURRENT_LIMIT -> DoubleSupplier { supplyConfig.currentLimit }
