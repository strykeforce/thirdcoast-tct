            ...
            "fxs" -> {
                if (bus == "rio") {
                    ...
                    talonFxsFDService.active.forEach {
                        talonFxFDService.grapherStatusFrameHz = 0.0;
                        it.acceleration.setUpdateFrequency(100.0, timeout)
                        it.bridgeOutput.setUpdateFrequency(100.0, timeout)
                        it.deviceTemp.setUpdateFrequency(100.0, timeout)
                        it.differentialAveragePosition.setUpdateFrequency(100.0, timeout)
                        it.differentialAverageVelocity.setUpdateFrequency(100.0, timeout)
                        it.differentialDifferencePosition.setUpdateFrequency(100.0, timeout)
                        it.differentialDifferenceVelocity.setUpdateFrequency(100.0, timeout)
                        it.dutyCycle.setUpdateFrequency(100.0, timeout)
                        it.forwardLimit.setUpdateFrequency(100.0, timeout)
                        it.reverseLimit.setUpdateFrequency(100.0, timeout)
                        it.isProLicensed.setUpdateFrequency(4.0, timeout)
                        it.motionMagicIsRunning.setUpdateFrequency(100.0, timeout)
                        it.motorVoltage.setUpdateFrequency(100.0, timeout)
                        it.position.setUpdateFrequency(100.0, timeout)
                        it.processorTemp.setUpdateFrequency(100.0, timeout)
                        it.rotorPosition.setUpdateFrequency(100.0, timeout)
                        it.rotorVelocity.setUpdateFrequency(100.0, timeout)
                        it.statorCurrent.setUpdateFrequency(100.0, timeout)
                        it.supplyCurrent.setUpdateFrequency(100.0, timeout)
                        it.supplyVoltage.setUpdateFrequency(100.0, timeout)
                        it.torqueCurrent.setUpdateFrequency(100.0, timeout)
                        it.velocity.setUpdateFrequency(100.0, timeout)

                        it.closedLoopDerivativeOutput.setUpdateFrequency(100.0, timeout)
                        it.closedLoopError.setUpdateFrequency(100.0, timeout)
                        it.closedLoopFeedForward.setUpdateFrequency(100.0, timeout)
                        it.closedLoopIntegratedOutput.setUpdateFrequency(100.0, timeout)
                        it.closedLoopOutput.setUpdateFrequency(100.0, timeout)
                        it.closedLoopProportionalOutput.setUpdateFrequency(100.0, timeout)
                        it.closedLoopReference.setUpdateFrequency(100.0, timeout)
                        it.closedLoopReferenceSlope.setUpdateFrequency(100.0, timeout)
                        it.closedLoopSlot.setUpdateFrequency(100.0, timeout)
                        it.differentialClosedLoopDerivativeOutput.setUpdateFrequency(100.0, timeout)
                        it.differentialClosedLoopError.setUpdateFrequency(100.0, timeout)
                        it.differentialClosedLoopFeedForward.setUpdateFrequency(100.0, timeout)
                        it.differentialClosedLoopIntegratedOutput.setUpdateFrequency(100.0, timeout)
                        ...
                        it.ancillaryDeviceTemp.setUpdateFrequency(100.0, timeout)
                        it.externalMotorTemp.setUpdateFrequency(100.0, timeout)
                        it.rawPulseWidthPosition.setUpdateFrequency(0.0,timeout)
                        it.rawQuadraturePosition.setUpdateFrequency(0.0, timeout)
                        it.rawPulseWidthVelocity.setUpdateFrequency(0.0, timeout)
                        it.rawQuadratureVelocity.setUpdateFrequency(0.0, timeout)
